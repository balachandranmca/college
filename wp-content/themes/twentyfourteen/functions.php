...
function twentyfourteen_scripts() {
	...
	wp_enqueue_style( 'animate', get_template_directory_uri() . '/css/vendor/slit-slider.css');
	wp_enqueue_style( 'slit-slider', get_template_directory_uri() . '/css/vendor/font-awesome.min.css');
