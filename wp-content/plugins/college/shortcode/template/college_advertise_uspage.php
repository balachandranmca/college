<div class="container slider-creator">
	<div class="row">
      <div class="col-md-3">
        <img src="<?php echo site_url();?>/wp-content/themes/twentyfourteen/img/advertise.jpg" class="img-responsive center-block" alt="">
      </div><!--.col -->
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 slider_image">
                            ...
                            <input type="hidden" id="conference_id" value="<?php echo $conference['id'];?>">
                        </div>
                    </div>
                    <div class="form-group">
                    <label class="col-md-3 control-label" for="name">Description</label>
                    <div class="col-md-9 slider_image">
                        <textarea rows="6" placeholder="Your Comments" class="form-control" name="description" id="description"><?php echo $conference['description'];?></textarea>
                    </div>
                    <div class="form-group">
...
<script>
    ...
    jQuery(document).on('click', '#image_upload', function(e){
        ...
        if(jQuery('.file-upload').val()=="" && jQuery('#conference_id').val()==""){
            noerrorFlag=0;
        }
