...
<div class="container admin-dashboard-block">
    <div class="row admin-dashboard">
        ...
        <div class="col-md-offset-1 col-xs-12 col-md-12">
            ...
            <div class="col-xs-12 col-sm-3 col-md-3">
                <a href="<?php echo get_buzz_url('college_author_paper_list')?>?key=published" class="btn btn-review btn-lg" role="button"><span><?php echo $published;?></span> <br/>Published Paper</a>
            </div>
        </div>
    </div>
</div>
