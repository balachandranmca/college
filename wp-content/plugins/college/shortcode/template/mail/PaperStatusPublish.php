                ...
                <table class="content" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td class="padded">
                          ...
                          <p>We are happy to inform you the following paper authored by you is published in our journal “International Journal of Research in Engineering, Science and Technologies (IJRESTs)” </p>
                          <p>You can check your paper status by login author’s ID</p>
                          <p><b>Paper ID # </b><?php echo $paper_referer_no?>
                          <br><b>Paper Title: </b><?php echo $paper_title;?>
                          <p>Looking forward for your further contribution of papers.</p>
