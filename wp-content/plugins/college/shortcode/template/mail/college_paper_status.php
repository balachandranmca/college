                ...
                <table class="content" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td class="padded">
                          ...
                          <p>Your Paper Status has been changed. Please check</p>     
                          <p style="text-align:center;"><a href="<?php echo $url;?>" class="btn">Click</a></p>
                        </td>
                    </tr>
                    </tbody>
                </table>
    ...
    <table class="footer center" width="602" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td class="signature" width="300">
                <p>
                    Name: Dr. Y.R.M. Rao,B.E, (Civil)., M.E., Ph.D.,   <br>           
					Editor-in-Chief (IJRESTs),<br>
                    PLOT #3, II FLOOR, JAWAHAR NAGAR, <br>
					3rd CROSS, BHOOMIANPET,      <br>
					PONDICHERRY -605005.<br>
                    +91-9786777229<br>
                    </p>
                <p>
                    Support: <a class="strong" href="mailto:#" target="_blank">editor@ijrests.org</a>
                </p>
            </td>
            <td class="subscription" width="300">
                <div class="logo-image">
                    <a href="http://zavoloklom.github.io/material-design-iconic-font/" target="_blank">
					<img src="../twentyfourteen/img/header-logo.png" alt="logo-alt" width="70" height="70"></a>
                </div>
                <p>
                </p>
            </td>
